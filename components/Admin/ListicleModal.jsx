            ...
            <div className={errors.sub_prompts ? 'has-error' : ''} style={{ border: errors.sub_prompts ? '1px solid #ff4444' : undefined, borderRadius: '14px', padding: errors.sub_prompts ? '20px' : '0' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                {(formData.sub_prompts || []).map((sp, index) => (
                  <div key={index} style={{ background: 'var(--surface-1)', border: '1px solid var(--border-color)', padding: '25px', borderRadius: '15px', position: 'relative' }}>
                    <button 
                      type="button" 
                ...
                <button 
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '14px 24px', borderRadius: '12px', background: 'var(--surface-2)', border: '1px solid var(--border-color)', color: 'var(--text-main)', cursor: 'pointer', fontWeight: 600, alignSelf: 'flex-start' }}
                >
