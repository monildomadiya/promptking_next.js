...
const HighlightText = ({ text, highlight }) => {
  ...
  const parts = String(text).split(new RegExp(`(${highlight.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\const CategorySidebar = ({ filter, setFilter, counts = {} }) => {')})`, 'gi'));
  return (
    <span>
      {parts.map((part, i) => 
...
const FilterItem = ({ label, value, icon: Icon, count, onClick, to, isActive, searchTerm }) => {
    ...
    <div className="category-sidebar ecommerce-filter-ui" style={{ 
      ...
      <FilterGroup title="Quick Filters">
        <FilterItem 
          ...
          onClick={() => setFilter('all')} 
          to="/"
         isActive={filter === 'all'} searchTerm={searchTerm} />
        <FilterItem 
          label="Free Access" 
          value="free" 
          count={counts.free} 
          ...
          to="/"
         isActive={filter === 'free'} searchTerm={searchTerm} />
        <FilterItem 
          label="Premium King" 
          value="premium" 
          ...
          to="/"
         isActive={filter === 'premium'} searchTerm={searchTerm} />
