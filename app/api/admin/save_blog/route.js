...
export async function POST(req) {
  try {
    ...
    const fields = {
      ...
      tags: (body.tags && Array.isArray(body.tags) && body.tags.length > 0) ? JSON.stringify(body.tags) : null,
      ...
      faqs: (body.faqs && Array.isArray(body.faqs) && body.faqs.length > 0) ? JSON.stringify(body.faqs) : null,
